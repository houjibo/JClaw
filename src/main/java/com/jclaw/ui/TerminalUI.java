...
@CommandLine.Command(
    ...
    subcommands = {
        // Git 相关
        com.jclaw.command.impl.GitCommand.class,
        com.jclaw.command.impl.BranchCommand.class,
        com.jclaw.command.impl.CommitCommand.class,
        com.jclaw.command.impl.DiffCommand.class,
        com.jclaw.command.impl.ReviewCommand.class,
        // 系统管理
        com.jclaw.command.impl.ConfigCommand.class,
        com.jclaw.command.impl.StatusCommand.class,
        com.jclaw.command.impl.StatsCommand.class,
        com.jclaw.command.impl.DebugCommand.class,
        com.jclaw.command.impl.UpgradeCommand.class,
        // 会话管理
        com.jclaw.command.impl.SessionCommand.class,
        com.jclaw.command.impl.ClearCommand.class,
        com.jclaw.command.impl.ModelCommand.class,
        com.jclaw.command.impl.RenameCommand.class,
        com.jclaw.command.impl.ResumeCommand.class,
        // 文件操作
        com.jclaw.command.impl.CatCommand.class,
        com.jclaw.command.impl.FilesCommand.class,
        com.jclaw.command.impl.FindCommand.class,
        // AI 相关
        com.jclaw.command.impl.AICommand.class,
        com.jclaw.command.impl.AgentsCommand.class,
        // 其他
        com.jclaw.command.impl.HelpCommand.class,
        com.jclaw.command.impl.VersionCommand.class,
        com.jclaw.command.impl.ExitCommand.class
    }
)
